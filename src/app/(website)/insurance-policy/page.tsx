    ...
    <div className="container mx-auto px-8 pt-8 pb-24 font-avenir">
      ...
      <div className="space-y-12 text-gray-800 leading-relaxed">
        ...
        <div className="space-y-4">
          <p>
            Muse Gala is committed to protecting both our valued customers and
            lending partners. This insurance policy offers peace of mind for
            renters in the event of accidental damage, while giving lenders
            confidence that their garments are supported.
          </p>
          <p>
            Below is a clear overview of what is covered, how damage is
            classified, and how reimbursements are processed.
          </p>
        </div>
          ...
          <div className="space-y-6 ml-4">
            ...
            <div>
              ...
              <ul className="space-y-2 ml-8">
                ...
                <li>
                  • Select major issues (e.g. large tears or deep stains),
                  subject to case-by-case review and approval
                </li>
              </ul>
            </div>
          ...
          <div className="space-y-6 ml-4">
            <div>
              ...
              <ul className="space-y-2 ml-8">
                ...
                <li>
                  • If repairs exceed $30, lenders may submit a valid receipt
                  for additional reimbursement:
                </li>
              </ul>

              <div className="ml-8">
                <p className="font-medium mt-3">RRP of Item → Maximum Additional Reimbursement</p>
            ...
            <div>
              ...
              <p className="mt-3 ml-4">Examples include:</p>
              <ul className="space-y-2 ml-8">
                <li>• Deep or permanent stains (e.g. ink, red wine, dye transfer)</li>
                ...
                <li>• Alterations that affect the garment’s intended fit or design</li>
              </ul>

              <p className="mt-3 ml-4">If insurance was purchased:</p>
              <ul className="space-y-2 ml-8">
                <li>
                  • The lender must submit photographic evidence and a repair
                  quote or replacement receipt
                </li>
                <li>
              ...
              <div className="ml-8">
                <p className="font-medium mt-3">RRP of Item → Maximum Reimbursement</p>
                <ul className="space-y-2 ml-6">
        ...
        <section>
          ...
          <p className="mb-4 ml-4">Lenders must submit a claim within 48 hours of receiving the returned item. Claims should include:</p>
          <ul className="space-y-2 ml-8">
            <li>• Clear images of the damage</li>
            <li>• A valid repair quote or replacement invoice (for major damage)</li>
          </ul>
          <p className="mt-3 ml-4">
        ...
        <section>
          ...
          <ul className="space-y-3 ml-4">
            <li>• The $5 insurance fee is non-refundable once a booking is confirmed</li>
            <li>• Repeated garment misuse may result in customer account suspension</li>
            <li>• Muse Gala reserves the right to reject any fraudulent or excessive claims</li>
